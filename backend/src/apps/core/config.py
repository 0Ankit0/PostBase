...
class Settings(BaseSettings):
    ...
    POSTBASE_WEBHOOK_TIMEOUT_MS: int = 5_000
    POSTBASE_WEBHOOK_RETRY_CEILING: int = 6
    POSTBASE_WEBHOOK_CIRCUIT_BREAKER_FAILURE_THRESHOLD: int = 8
    POSTBASE_WEBHOOK_BACKLOG_ALERT_THRESHOLD: int = 150
    POSTBASE_WEBHOOK_DELIVERY_FAILURE_ALERT_THRESHOLD: int = 25
    POSTBASE_WEBHOOK_AUTH_ANOMALY_ALERT_THRESHOLD: int = 3
